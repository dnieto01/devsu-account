...
public class KafkaConfig {
    ...
    @Bean
    public ByteArrayJacksonJsonMessageConverter jsonMessageConverter(ObjectMapper objectMapper) {
        return new ByteArrayJacksonJsonMessageConverter((JsonMapper) objectMapper);
    }
}